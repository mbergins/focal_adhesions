function bsf(string, n, var1_name, var2_name)
...
%
%
% SYNOPSIS      bsf('common_file_name', n, 'var1_name', 'var2_name')
%
...
% OUTPUT               : 
%
% Mohsen Sabouri Ghomi 5/2/07.
%
% This is for people who
% don't want to calculate the significance levels for their bootstraped
% correlation coefficients. Significance levels are tricky to plot. 
% Significance levels for spatial correlations require correlations from 
% individual cells obtained with equal number of segments along the edge.
% For temporal correaltions, significant levels require the individual
% correlations to be obtained with equal no. of images (time points). 
% 
% To calculate the significance levels for your bootstrap correlation use
% the function: bsf_w_sig_lev.m
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
