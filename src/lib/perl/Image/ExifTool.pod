...
Binary, Charset, CharsetEXIF, CharsetID3, CharsetIPTC, Composite,
...
OpenEXR, PDF, PICT, PNG, PSP, PhotoMechanic, Photoshop, PostScript, PrintIM,
QuickTime, RAF, RIFF, RSRC, RTF, Radiance, Rawzor, Real, SVG, SigmaRaw,
Stim, Theora, Vorbis, XML, XMP, ZIP
...
NikonScan, Ocad, Ogg, Olympus, OpenEXR, PDF, PICT, PNG, PSP, Panasonic,
Pentax, PhotoMechanic, Photoshop, PictureInfo, PostScript, PreviewIFD,
PrintIM, ProfileIFD, QuickTime, RAF, RAF2, RIFF, RMETA, RSRC, RTF, Radiance,
Rawzor, Real, Real-CONT, Real-MDPR, Real-PROP, Real-RA3, Real-RA4, Real-RA5,
...
System, Theora, Track#, Version0, Vorbis, XML, XMP, XMP-DICOM, XMP-MP,
XMP-MP1, XMP-PixelLive, XMP-acdsee, XMP-album, XMP-aux, XMP-cc, XMP-cell,
XMP-crs, XMP-dc, XMP-dex, XMP-digiKam, XMP-exif, XMP-extensis, XMP-iptcCore,
...
little-endian Unicode, and are read and written using the specified
character set.
