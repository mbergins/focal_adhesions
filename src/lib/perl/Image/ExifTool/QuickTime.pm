...
my %timeInfo = (
    ...
    ValueConv => 'ConvertUnixTime($val - ((66 * 365 + 17) * 24 * 3600), $self->Options("QuickTimeUTC"))',
...
%Image::ExifTool::QuickTime::Main = (
    ...
    NOTES => q{
        ...
        stored as UTC.  Unfortunately, digital cameras will often store local time
        values instead, presumably because they don't know the time zone.  For this
