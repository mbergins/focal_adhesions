...
imwrite(not(small_both),'edge_and_ad_1_no_conv.bmp');
system('/sw/bin/potrace -s -t 0 edge_and_ad_1_no_conv.bmp');
system('rm edge_and_ad_1_no_conv.bmp');

focal_image = imread(fullfile(base_dir,'021/focal_image.png'));
cell_mask = imread(fullfile(base_dir,'021/cell_mask.png'));
ad_binary = imread(fullfile(base_dir,'021/adhesions_binary.png'));
ad_label = imread(fullfile(base_dir,'021/adhesions.png'));
...
imwrite(not(small_both),'edge_and_ad_2_no_conv.bmp');
system('/sw/bin/potrace -s -t 0 edge_and_ad_2_no_conv.bmp');
system('rm edge_and_ad_2_no_conv.bmp');
...
imwrite(not(small_both),'edge_and_ad_3_no_conv.bmp');
system('/sw/bin/potrace -s -t 0 edge_and_ad_3_no_conv.bmp');
system('rm edge_and_ad_3_no_conv.bmp');