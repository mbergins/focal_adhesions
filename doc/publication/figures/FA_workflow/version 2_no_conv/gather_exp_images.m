...
% system('rm edge_and_ad_1.bmp');
% 
% focal_image = imread('../../../../results/focal_adhesions/time_series_04/individual_pictures/05/focal_image.png');
% cell_mask = imread('../../../../results/focal_adhesions/time_series_04/individual_pictures/05/cell_mask.png');
% ad_binary = imread('../../../../results/focal_adhesions/time_series_04/individual_pictures/05/adhesions_binary.png');
% 
% big_edge = bwperim(imdilate(cell_mask,strel('disk',3)));
% 
% both = or(big_edge,ad_binary);
